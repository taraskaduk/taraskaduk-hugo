...
aliases:
    - /post/power-query
header:
  image: post/power-query/head.png
 twitterImg: post/power-query/head.png
---
...
```{r echo=FALSE}
library(blogdown)
shortcode("tweet", "962376095323643910")
shortcode("tweet", "970708905251737605")
shortcode("tweet", "935263135413555203")
```

However, I'll also be the first to jump in Excel's defense whenever an opportunity presents itself:
```{r echo=FALSE}
library(blogdown)
shortcode("tweet", "946035002571218944")
```
...
![](/post/power-query/test1.png){width=50%}
...
![](/post/power-query/test2.png){width=50%}
...
![](/post/power-query/gui1.png)
![](/post/power-query/gui2.png)
