...
author: Taras Kaduk
featured: "shiny_rate.gif"
featuredpath: "/post/2018-01-shiny-rate"
date: '2018-01-13'
slug: shiny_rate
categories:
  - R
...
tags:
  ...
  - r
header:
  image: post/shiny-rate/shiny_app_rate_files/shiny_rate.gif
---
## *(One year after building it and forgetting it)*

*Cross-posted: [**Medium**](https://medium.com/taras-kaduk/my-first-shiny-app-calculating-your-hourly-rate-as-a-consultant-97abe5296a37)*
...
![](/post/shiny-rate/figures/1.png){width=100%}
...
![](/post/shiny-rate/figures/2.png){width=100%}
...
![Changing the rate from $75 to $84/hour](/post/shiny-rate/figures/3.png){width=100%}
![Changing the rate to $80/hour and working 50 weeks a year](/post/shiny-rate/figures/3.png){width=100%}
